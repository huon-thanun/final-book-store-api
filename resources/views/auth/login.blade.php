...
<head>
    ...
    <title>ចូលប្រើប្រាស់ — R-BookStore</title>
...
<body>
    ...
    <div class="login-panel-right">
        <div class="login-form-wrap">
            ...
            <h1 class="form-heading">ចូលប្រើប្រាស់</h1>
            <p class="form-sub">បញ្ចូលអ៊ីមែល និងលេខសម្ងាត់ដើម្បីបន្ត</p>
            ...
            <form action="{{ route('login.perform') }}" method="POST">
                ...
                <button type="submit" class="submit-btn">
                    <i class="fa-solid fa-arrow-right-to-bracket me-2"></i>ចូលប្រព័ន្ធ
                </button>

                {{-- 🌟 បន្ថែមផ្នែកនេះចូល --}}
                <div class="text-center mt-4 small" style="color: var(--text-muted);">
                    មិនទាន់មានគណនីមែនទេ? <a href="{{ route('register') }}" style="color: var(--accent); text-decoration: none; font-weight: 600;">ចុះឈ្មោះគណនីថ្មីនៅទីនេះ</a>
                </div>
            </form>
        </div>
    </div>
